...
export const zh = {
  ...
  'file.dropTitle': '拖动图片或文件到此处即可添加',
  'file.dropDesc': '图片最多 {count} 张、每张 {size}；文件单个不超过 {fileSize}',
  'file.dropBlocked': '当前无法添加图片或文件',
  'file.pending': '待发送文件',
  'file.remove': '移除文件 {name}',
  'file.label': '文件',
  'file.tooLarge': '单个文件不能超过 {size}',
  'file.empty': '文件内容为空，请重新选择',
  'file.writeFailed': '文件保存失败，请重试',
  'file.mention': '[用户上传了文件] {name}（已保存至工作区 {path}）',
  'file.mentionMany': '[用户上传了 {count} 个文件，已保存至工作区]\n{list}',
  'image.pending': '待发送图片',
...
export const en = {
  ...
  'file.dropTitle': 'Drag images or files here to add them',
  'file.dropDesc': 'Up to {count} images at {size} each; files up to {fileSize}',
  'file.dropBlocked': 'Images or files cannot be added right now',
  'file.pending': 'Pending files',
  'file.remove': 'Remove file {name}',
  'file.label': 'File',
  'file.tooLarge': 'Each file must be smaller than {size}',
  'file.empty': 'The file is empty; choose another one',
  'file.writeFailed': 'Saving the file failed; try again',
  'file.mention': '[User attached a file] {name} (saved to workspace {path})',
  'file.mentionMany': '[User attached {count} files, saved to the workspace]\n{list}',
